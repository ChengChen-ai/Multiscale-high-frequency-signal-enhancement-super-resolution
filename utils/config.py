...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.TRAINING.TRAIN_DIR = '../datasets/trainData'
        self._C.TRAINING.VAL_DIR = '../datasets/validationData'
        self._C.TRAINING.SAVE_DIR = 'pretrained_model'
        self._C.TRAINING.TRAIN_PS = 64
        self._C.TRAINING.VAL_PS = 64
        self._C.TRAINING.DISPLAY_ID = 1
        self._C.TRAINING.BACKWARD_TYPE = 'fused'
        self._C.TRAINING.TRAIN = False
